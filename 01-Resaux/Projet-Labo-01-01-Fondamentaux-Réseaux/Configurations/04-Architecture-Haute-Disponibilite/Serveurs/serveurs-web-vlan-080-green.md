# Serveur Web - VLAN 80 (Green)

## Présentation

Ce serveur Web est hébergé sur le **VLAN 80 (Green)** et met à disposition un site Internet accessible depuis le réseau interne ainsi que depuis le réseau extérieur grâce aux règles de traduction d'adresses (NAT/PAT) configurées sur le routeur **R-9**.
...
| Paramètre | Valeur |
|-----------|---------|
| Nom | Serveur Web VLAN 80 |
| VLAN | 80 (Green) |
| Adresse IP | 192.168.8.250 |
| Masque | 255.255.255.0 |
| Passerelle | 192.168.8.254 (HSRP) |
| Service | HTTP |
...
|------------------|----------------|------|
| 100.0.18.253 | 192.168.8.250 | TCP/8008 |

Configuration Cisco utilisée :

```cisco
ip nat inside source static tcp 192.168.8.250 80 100.0.18.253 8008
```
...
- Les postes du VLAN 80 accèdent au serveur.
